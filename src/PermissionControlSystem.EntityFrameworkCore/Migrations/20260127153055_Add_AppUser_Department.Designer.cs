...
namespace PermissionControlSystem.Migrations
{
    ...
    [Migration("20260127153055_Add_AppUser_Department")]
    partial class Add_AppUser_Department
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PermissionControlSystem.Departments2.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionControlSystem.Events.IncomingMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppIncomingMessages", (string)null);
                });

            modelBuilder.Entity("PermissionControlSystem.Leaves2.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionControlSystem.Leaves2.LeaveType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionControlSystem.Users.AppUser", b =>
                {
            ...
            modelBuilder.Entity("PermissionControlSystem.Users.AppUser", b =>
                {
                    b.HasOne("PermissionControlSystem.Departments2.Department", "Department")
                        .WithMany()
