...
namespace PermissionControlSystem.Migrations
{
    ...
    [Migration("20260210101658_Fix_Employee_Relation")]
    partial class Fix_Employee_Relation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PermissionControlSystem.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionControlSystem.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionControlSystem.Leaves.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionControlSystem.Employees.Employee", b =>
                {
                    b.HasOne("PermissionControlSystem.Departments.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PermissionControlSystem.Departments.Department", null)
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("PermissionControlSystem.Leaves.LeaveRequest", b =>
                {
                    b.HasOne("PermissionControlSystem.Employees.Employee", null)
