...
{
    [DbContext(typeof(PermissionControlSystemDbContext))]
    [Migration("20260210115535_Added_Employee_Navigation_To_LeaveRequest")]
    partial class Added_Employee_Navigation_To_LeaveRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PermissionControlSystem.Entities.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionControlSystem.Entities.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionControlSystem.Entities.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionControlSystem.Entities.Employee", b =>
                {
                    b.HasOne("PermissionControlSystem.Entities.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PermissionControlSystem.Entities.Department", null)
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("PermissionControlSystem.Entities.LeaveRequest", b =>
                {
                    b.HasOne("PermissionControlSystem.Entities.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PermissionControlSystem.Entities.Employee", null)
